<template>
  <div>
    ...
    <b-form @submit.prevent="handleSubmit">
      <b-form-group id="gca_rules_1" label="Nom du contact principal" label-for="gca_rules_1-select">
        <b-form-select id="gca_rules_1-select" v-model="formData.gca_1" :options="options" required></b-form-select>
      </b-form-group>
      <b-form-group id="gca_rules_1_comment" label="Nom du contact principal" label-for="gca_rules_1_comment-select">
        <b-form-input id="gca_rules_1_comment-input" v-model="formData.gca_1_comment" placeholder="Commentaire"></b-form-input>
      </b-form-group>
      <b-form-group id="gca_rules_1_impact" label="Nom du contact principal" label-for="gca_rules_1_impact-select">
        <b-form-select id="gca_rules_1_impact-select" v-model="formData.gca_1_impact" :options="options2" required></b-form-select>
      </b-form-group>
      <b-form-group id="gca_rules_1_engie" label="Nom du contact principal" label-for="gca_rules_1_engie-select">
        <b-form-input id="gca_rules_1_engie-input" v-model="formData.gca_1_engie" placeholder="Commentaire"></b-form-input>
      </b-form-group>
      <b-form-group id="gca_rules_2" label="Nom du contact principal" label-for="gca_rules_2-select">
        <b-form-select id="gca_rules_2-select" v-model="formData.gca_2" :options="options" required></b-form-select>
      </b-form-group>
      <b-form-group id="gca_rules_2_comment" label="Nom du contact principal" label-for="gca_rules_2_comment-select">
        <b-form-input id="gca_rules_2_comment-input" v-model="formData.gca_2_comment" placeholder="Commentaire"></b-form-input>
      </b-form-group>
      <b-form-group id="gca_rules_2_impact" label="Nom du contact principal" label-for="gca_rules_2_impact-select">
        <b-form-select id="gca_rules_2_impact-select" v-model="formData.gca_2_impact" :options="options2" required></b-form-select>
      </b-form-group>d
      <b-form-group id="gca_rules_2_engie" label="Nom du contact principal" label-for="gca_rules_2_engie-select">
        <b-form-input id="gca_rules_2_engie-input" v-model="formData.gca_2_engie" placeholder="Commentaire"></b-form-input>
      </b-form-group>
      <b-form-group id="gca_rules_3" label="Nom du contact principal" label-for="gca_rules_3-select">
        <b-form-select id="gca_rules_3-select" v-model="formData.a_3" :options="options" required></b-form-select>
      </b-form-group>
      <b-form-group id="gca_rules_3_comment" label="Nom du contact principal" label-for="gca_rules_3_comment-select">
        <b-form-input id="gca_rules_3_comment-input" v-model="formData.gca_3_comment" placeholder="Commentaire"></b-form-input>
      </b-form-group>
      <b-form-group id="gca_rules_3_impact" label="Nom du contact principal" label-for="gca_rules_3_impact-select">
        <b-form-select id="gca_rules_3_impact-select" v-model="formData.gca_3_impact" :options="options2" required></b-form-select>
      </b-form-group>
      <b-form-group id="gca_rules_3_engie" label="Nom du contact principal" label-for="gca_rules_3_engie-select">
